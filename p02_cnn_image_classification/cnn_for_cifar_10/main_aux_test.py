...
from p02_cnn_image_classification.cnn_for_cifar_10.ensemble_cnn_model_aux_test import Model
    ...
    for epoch in range(training_epochs):
        ...
        if len(early_stopping_list) >= 2:
            ...
            if diff > 2:
                ...
                for m in models:
                    m.early_stop_count = early_stop_count
                    m.epoch = epoch
...
with tf.Session() as sess:
    ...
    # saver.restore(sess, 'log/epoch_50.ckpt')
